...
<section className={styles.form}>
    <div className={styles.leftSection}>
        ...
        <form id="contact" className={styles.contact} name="Contact Form" method="post" data-netlify-recaptcha="true" data-netlify="true">
                ...
                <div className={styles.inputGroup}>
                    ...
                    <div aria-hidden="true" className={styles.hoverBox}></div></div>
                </div>
            <p className={styles.formSubmit}>
                <Button name="submit" type="submit" id="contact-submit" className="button-solid" data-submit="...Sending" sx={{ px: "6px", py: "1px", border:"none", ":hover": {
                    background: "#0e817c",
                } }}>Submit</Button>
            </p>
        </form>
    ...
    <div className={styles.contactRight}>
        ...
        <div className={styles.infoGroup}>
            ...
            <a className={styles.info} href="tel:555-213-9120">(555) 213-9120</a>
        </div>
        <div className={styles.infoGroup}>
            <span className={styles.heading}>Email</span>
            <a className={styles.info} href="mailto:info@email.com">info@email.com</a>
        </div>
        <div className={styles.infoGroup}>
