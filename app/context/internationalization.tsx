...
type InternationalizatinContextProps = {
  language: [
    ...
    Dispatch<SetStateAction<SupportedLanguages | null>>,
  ]
}

export const InternationalizatinContext = createContext(
  {} as InternationalizatinContextProps
)
...
export const InternationalizationProvider: React.FC<{
  ...
  return (
    <InternationalizatinContext.Provider value={contextValue}>
      {children}
    </InternationalizatinContext.Provider>
  )
}
